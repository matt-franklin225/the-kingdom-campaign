            ...
            <div className="gradient__bg">
                ...
                <div className="character_detail-info section__padding">
                    <div className="character_detail-info-heading">
                        <div className="character_detail-name">
                            <h1>{character.name}</h1>
                        </div>
                        <div className="character_detail-image">
                            <img src={character.imgUrl} alt={character.name}/>
                        </div>
                        <div className="character_detail-title">
                            <h2>{character.title}</h2>
                        </div>
                    </div>
                    <div className="character_detail-info-details">
                        <div className="character_detail-trait">
                            <h2>{'Class:'}</h2>
                        </div>
                        <div className="character_detail-value">
                ...
                <div className="character_detail-description">
                    <h1>Description</h1>
                    <div className="character_detail-description-text">
